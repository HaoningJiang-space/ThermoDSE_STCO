...
plt.plot(x, y[1], linewidth= 3, label='SA-300')

plt.plot(x, y[2], linewidth= 3, label='SA-400')

plt.scatter(cov4,max_cost4, s=80, color='blue', marker='*', edgecolors='blue',
            label='temp=200', zorder=5)

plt.scatter(cov10,max_cost10, s=80, color='orange', marker='*', edgecolors='orange',
            label='temp=300', zorder=5)

plt.scatter(cov16,max_cost16, s=80, color='green', marker='*', edgecolors='green',
            label='temp=400', zorder=5)

plt.text(cov4, max_cost4-35, f'({cov4}, {max_cost4})', fontsize=6, color='blue',  ha='center', va='top')
plt.text(cov10, max_cost10-35, f'({cov10}, {max_cost10})', fontsize=6, color='orange',  ha='center', va='top')
plt.text(cov16, max_cost16-40, f'({cov16}, {max_cost16})', fontsize=6, color='green',  ha='center', va='top')
